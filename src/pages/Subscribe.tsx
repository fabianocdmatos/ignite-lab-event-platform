...
export function Subscribe() {
  ...
  const handlSendForm = async (event: FormEvent) => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-blur bg-cover bg-no-repeat items-center">
      <div className="w-full flex items-center justify-between max-w-[1100px] mt-20 mx-auto">
        ...
        <div className="p-8 bg-gray-700 border border-gray-500 rounded">
          ...
          <form onSubmit={handlSendForm} className="flex flex-col gap-2 w-full">
            <input
              type="text"
